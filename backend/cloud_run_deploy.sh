...
gcloud run deploy backend --image asia-southeast1-docker.pkg.dev/x-object-425917-m2/test-repo/ainbox_backend --platform managed --region asia-southeast1 --allow-unauthenticated --port 3002 --memory 2Gi
